...
module.exports = class RoonAdapter extends EventEmitter {
    ...
    start() {
        return new Promise((resolve, reject) => {
            ...
            this._svcSourceControl = new RoonApiSourceControl(roon);

            roon.init_services({
                required_services: [ RoonApiTransport ],
                provided_services: [ this._svcStatus, this._svcSourceControl ]
            });
    ...
    registerSourceControl(sourceControl) {
        sourceControl._handle = this._svcSourceControl.new_device(sourceControl);
    }

    unregisterSourceControl(sourceControl) {
        sourceControl._handle.destroy()
        sourceControl._handle = null;
    }
